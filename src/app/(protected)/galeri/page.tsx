...
import { Search, SlidersHorizontal, /* Armchair, Table2, Sofa, Archive, Trees, Sparkles, Layers, Palette */ Clock, Download, TrendingUp } from "lucide-react";
...
export default function GaleriPage() {
    const { /* selectedCategory, setSelectedCategory, */ searchQuery, setSearchQuery, sortBy, setSortBy, fetchImages, loading } = useGalleries();
                ...
                <div className="relative p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">
                            {loading ? "Memuat galeri..." : `Jelajahi inspirasi desain furniture rotan dari komunitas`}
                        </p>
                    </div>
                    ...
                    <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="relative flex-1 lg:max-w-md">
                            ...
                            <Input
                                ...
                                className="pl-10 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100 dark:placeholder:text-neutral-400"
                            />
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            <Button
                                variant="outline"
                                size="sm"
                                className="gap-2 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700"
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium transition ${
                                            selectedCategory === category.id
                                                ? "border-purple-500 bg-purple-50 text-purple-700 dark:border-purple-500 dark:bg-purple-950/30 dark:text-purple-400"
                                                : "border-neutral-200 bg-white text-neutral-600 hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:border-neutral-600 dark:hover:bg-neutral-700"
                                        }`}
                                    >
                                        ...
                                        {sortOptions.map((option) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`flex flex-1 items-center justify-center gap-2 rounded-lg border px-3 py-2 text-xs font-medium transition ${
                                                        sortBy === option.id
                                                            ? "border-purple-500 bg-purple-50 text-purple-700 dark:border-purple-500 dark:bg-purple-950/30 dark:text-purple-400"
