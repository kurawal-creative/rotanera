            ...
            <main className="relative w-full">
                ...
                <div className="relative p-6">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-semibold text-neutral-900">Canvas Studio</h1>
                            <p className="mt-1 text-sm text-neutral-600">
                                Project ID: <span className="font-mono text-purple-600">{id}</span>
                            </p>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="flex items-center gap-2 rounded-full bg-purple-50 px-4 py-2 text-sm font-medium text-purple-700">
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        ...
                        <div className="space-y-6 lg:col-span-2">
                            ...
                            {/* AI Generation Panel */}
                            <div className="rounded-2xl border border-purple-200 bg-linear-to-br from-purple-50 to-white p-6 shadow-sm">
                                <div className="mb-4 flex items-center gap-3">
                                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-purple-600">
                                        <Wand2 className="h-5 w-5 text-white" />
                                    </div>
                                    <div>
                                        <h2 className="text-lg font-semibold text-neutral-900">AI Generation</h2>
                                        <p className="text-sm text-neutral-600">Transform your design with AI</p>
                                    </div>
                                </div>

                                <div className="space-y-4">
                                    <div>
                                        <label htmlFor="prompt" className="mb-2 block text-sm font-medium text-neutral-700">
                                            Prompt
                                        </label>
                                        <div className="relative">
                                            <Sparkles className="absolute top-1/2 left-3 h-4 w-4 -translate-y-1/2 text-purple-500" />
                                            <Input id="prompt" type="text" value={prompt} onChange={(e) => setPrompt(e.target.value)} className="pl-10 focus:border-purple-500 focus:ring-purple-500" placeholder="Describe your desired transformation..." disabled={isProcessing} />
                                        </div>
                                    </div>
                                ...
                                {isProcessing && (
                                    <div className="mt-4 rounded-lg bg-purple-100 p-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-purple-900">Processing your image...</p>
                            ...
                            <div className="sticky top-6 rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                                <div className="mb-4 flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h2 className="text-lg font-semibold text-neutral-900">Recent Generations</h2>
                                    </div>
                                    {generatedImages.length > 0 && <span className="rounded-full bg-purple-100 px-3 py-1 text-xs font-medium text-purple-700">{generatedImages.length}</span>}
                                </div>
                                ...
                                {generatedImages.length === 0 ? (
                                    <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-neutral-200 bg-neutral-50 py-12">
                                        ...
                                        <p className="mb-1 text-sm font-medium text-neutral-900">No generations yet</p>
                                    ...
                                    <div className="max-h-[calc(100vh-16rem)] space-y-3 overflow-y-auto">
                                        {generatedImages.map((img, index) => (
                                            <div key={index} className="group relative aspect-square overflow-hidden rounded-xl border border-neutral-200 bg-linear-to-br from-purple-50 to-violet-100 transition-all hover:border-purple-300 hover:shadow-md">
