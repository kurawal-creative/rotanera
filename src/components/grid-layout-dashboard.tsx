...
const GridLayoutDashboard = () => {
    ...
    return (
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            {projects.map((p) => (
                <Link key={p.id} href={`/canvas/${p.id}`} className="group rounded-xl border bg-white p-3 shadow-sm transition hover:shadow-md dark:border-neutral-700 dark:bg-neutral-800/50">
