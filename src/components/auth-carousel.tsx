...
const testimonials = [
  {
    quote:
      "Platform ini punya semua fitur yang saya butuhkan untuk bikin blueprint rotan cepat dan presisi.",
    name: "Budi Santoso",
    role: "Pemilik Usaha Furnitur Rotan, Yogyakarta",
  },
  {
    quote:
      "AI-nya bantu banget kasih ide desain baru, sekarang pesanan ekspor saya naik 3 kali lipat!",
    name: "Siti Nurhayati",
    role: "Pengrajin Rotan & Eksportir, Cirebon",
  },
  {
    quote:
      "Dari sketsa tangan jadi blueprint 3D cuma hitungan menit. Hemat waktu dan tenaga banget!",
    name: "Agus Wijaya",
...
export default function AuthCarousel() {
  ...
  return (
    <motion.div
      className="hidden w-full max-w-md items-center justify-center lg:flex"
