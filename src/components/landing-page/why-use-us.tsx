...
export default function WhyUseUsSection() {
    return (
        <section className="mx-auto w-full max-w-7xl items-center px-4 pt-14 md:pt-10">
                        ...
                        {stats.map((s, i) => (
                            <div key={i} className="text-center">
                                <div className="flex items-baseline justify-center gap-1">
                                    <NumberTicker startValue={0} value={s.value} decimalPlaces={s.decimals} className="text-4xl font-bold md:text-5xl lg:text-6xl" />
