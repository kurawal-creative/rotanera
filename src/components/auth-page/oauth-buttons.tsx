...
export function OAuthButtons({ redirectTo = "/app/test" }: OAuthButtonsProps) {
    ...
    return (
        <div className="flex w-full flex-col gap-4 lg:flex-row">
            <button onClick={handleGoogleSignIn} disabled={isLoading} className="flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-2xl border-2 border-[#E0E1E2] bg-[#F9FAFB] transition duration-200 hover:border-[#C7C9CB] hover:bg-[#E8ECF1] disabled:cursor-not-allowed disabled:opacity-50">
                {isLoading ? (
